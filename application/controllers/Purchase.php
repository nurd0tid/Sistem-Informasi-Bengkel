...
class Purchase extends CI_Controller
{
    ...
    public function json_product()
    {
        ...
        $this->datatables->setColumn([
            ...
            '<get-motor>',
            '<get-jenisbarang>',
            '<div class="text-center"><button type="button" class="btn btn-warning btn-sm btn-choose" data-id="<get-id>" data-name="<get-name>" data-jenisbarang="<get-jenisbarang>" data-stock="<get-stock>"><i class="fa fa-check"></i></button></div>'
        ]);
