...
class Transaction extends CI_Controller
{
    ...
    function insert($action = "sparepart")
    {
        ...
        foreach ($data['sparepart'] as $itemSp) {
            ...
            $temp["motor"] = $itemSp["motor"];
            $temp["jenisbarang"] = $itemSp["jenisbarang"];
            $temp["price"] = $itemSp["price"];
            $temp["qty"] = $itemSp["qty"];
            $temp["tgl"] = date("Y-m-d H:i:s");
    ...
    {
        $addFunc = "addSparepartCart({id:<get-id>,name:'<get-name>',motor:'<get-motor>',jenisbarang:'<get-jenisbarang>',price:<get-price>,stock:<get-stock>})";
        ...
        $this->datatables->setOrdering(["kodepart", "name", "motor", "jenisbarang", "price",  NULL]);
