                ...
                <div class="col-md-7 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-content pt-3" id="nav-tabContents">
                            ...
                            <div class="tab-content pt-3" id="nav-tabContent">
                                <div class="tab-pane fade show" id="nav-sparepart" role="tabpanel" aria-labelledby="nav-sparepart-tab">
                                    <div class="table-responsive">
        ...
        <script>
            ...
            $("#dataTable1").DataTable({
                ...
                "lengthChange": false,
                "ajax": {
                    "url": "<?= base_url("transaction/json_sparepart"); ?>",
                }
            });
            ...
            $('#nav-services-tab').on("click", function() {
                ...
                $("#nav-tabContent").hide();
                $("#nav-tabContents").show();
                jQuery("#dataTable").DataTable().ajax.url("<?= base_url("transaction/json_service"); ?>").load();
            });
            $('#nav-sparepart-tab').on("click", function() {
                $("#nav-tabContents").hide();
                $("#nav-tabContent").show();
                jQuery("#dataTable1").DataTable().ajax.url("<?= base_url("transaction/json_sparepart"); ?>").load();
            });
            ...
            function refreshServiceCart(data1, data2) {
                ...
                data2.forEach(function(item, index) {
                    html2 += '<tr><td>' + item.name + '</td><td>' + item.motor + '</td><td>' + item.jenisbarang + '</td><td>Rp ' + item.price.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') + '</td><td class="text-center"><input type="number" style="width:52px" value="' + item.qty + '" class="change-qty" data-id="' + item.id + '" data-stock="' + item.stock + '"/></td></tr>';
                    countTotal = (countTotal + (item.price * item.qty));
