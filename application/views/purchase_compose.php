                    ...
                    <form>
                        ...
                        <table class="table table-bordered" id="purchaseForm">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="product-name form-control form-control-sm" data-id="" data-stock="">--Pilih--</div>
                                    </td>
                                    <td>
                                        <div class="product-jenis form-control form-control-sm" data-id="" data-jenis="" aria-disabled="true"></div>
                                    </td>
        ...
        <script>
            ...
            $(".btn-add-row").on("click", function() {
                ...
                jQuery("#purchaseForm tbody").append('<tr><td><div class="product-name form-control form-control-sm" data-id="" data-stock="">--Pilih--</div></td><td><div class="product-jenis form-control form-control-sm" data-id="" data-jenis="" aria-disaled="true"></div></td><td><input type="number" class="form-control form-control-sm" name="price"></td><td><input type="number" class="form-control form-control-sm" name="qty"></td><td class="text-center"><button type="button" class="btn btn-sm btn-danger btn-del"><i class="fa fa-times"></i></button></td></tr>');
            ...
            $('body').on("click", ".btn-choose", function() {
                ...
                jQuery("#purchaseForm tbody tr:nth-child(" + indexAffected + ") .product-motor").html(motor);
                jQuery("#purchaseForm tbody tr:nth-child(" + indexAffected + ") .product-jenis").html(jenisbarang);
            ...
            function postJson(json) {
                jQuery.ajax({
                    ...
                    success: function(data) {
                        if (data.status) {
                            jQuery(".supplier").val("");
                            jQuery("#purchaseForm tbody").html('<tr><td><div class="product-name form-control form-control-sm" data-id="" data-stock="">--Pilih--</div><td><div class="product-jenis form-control form-control-sm" data-id="" data-jenis="" aria-disaled="true"></div></td><td><input type="number" class="form-control form-control-sm" name="price"></td><td><input type="number" class="form-control form-control-sm" name="qty"></td><td class="text-center"><button type="button" class="btn btn-sm btn-danger btn-del"><i class="fa fa-times"></i></button></td></tr>');
