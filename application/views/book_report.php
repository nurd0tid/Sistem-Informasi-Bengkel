        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">Laporan Tutup Buku</li>
                </ol>
            </div>
        </div>
    </div>
...
<script>
    ...
    $("input[name=end]").on("change", function() {
        ...
        jQuery("#data").DataTable().ajax.url("<?= base_url("report/json_book"); ?>/" + start + "/" + end).load();
    });
    ...
    $(".btn-print").on("click", function() {
        ...
        if (start && end) {
            var url = "<?= base_url("report/book_pdf"); ?>/" + start + "/" + end;
        } else {
            var url = "<?= base_url("report/book_pdf"); ?>/";
        }
