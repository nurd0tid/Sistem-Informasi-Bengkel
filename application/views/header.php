            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="<?= base_url("dashboard/backupdb"); ?>"> <i class="menu-icon fa fa-database"></i>Backup Database </a>
                        </li>
                        ...
                        <li>
                            <a href="<?= base_url("report/book"); ?>"> <i class="menu-icon fa fa-bar-chart-o"></i>Tutup Buku</a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </nav>
